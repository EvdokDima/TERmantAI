...
while restart:
    ...
    if os.path.getsize('policy_memory.pt') > 0:
        policy_net = torch.load('policy_memory.pt')
        policy_net.eval()
    ...
    for i_episode in range(all_episodes, num_episodes):
        ...
        while alive:
            ...
            if i_episode >= 500:
                if max_alive_count < 7:
                    if os.path.getsize('policy_memory.pt') > 0 and os.path.getsize(
                            'target_memory.pt') > 0 and os.path.getsize('episodes.txt') > 0 and os.path.getsize('max_alive_count.txt'):
                        print('--------------------------------------------------')
                        print('Restarting AI')
                        print('--------------------------------------------------')
            ...
            if keyboard.is_pressed('q'):
                ...
                if os.path.getsize('policy_memory.pt') > 0 and os.path.getsize(
                        'target_memory.pt') > 0 and os.path.getsize('episodes.txt') > 0 and os.path.getsize(
                        'max_alive_count.txt'):
                    print('--------------------------------------------------')
                    print('Restarting AI')
                    print('--------------------------------------------------')
